                  ...
                  <tr key={task.id} className={`hover:bg-gray-50 transition-colors ${index % 2 === 0 ? 'bg-white' : 'bg-gray-25'}`}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-900 capitalize">{task.assignedUserId || "-"}</span>
                      </div>
                    </td>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                        ...
                        form.status === 'inprogress' ? 'bg-blue-100 text-blue-800' :
                        'bg-yellow-100 text-yellow-800'
                      }`}>
                        {form.status === 'done' ? 'Selesai' :
                         form.status === 'inprogress' ? 'Sedang Dalam Proses' :
                         'Belum Dikerjakan'}
                      </span>
                    </div>
                  </div>
